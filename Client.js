...
function PP_ER_clientValidateLine(type){
	...
	var projtype = nlapiLookupField('job', nlapiGetFieldValue('custbody_pp_er_project'), 'jobtype', true);
alert('projtype'+projtype)	;
if (projtype !='Contract')
	{
	nlapiSetCurrentLineItemValue('expense','isbillable','F',false);
	}
